var APP = Object.freeze({
  NAME: 'Agent Console',
  VERSION: '2.0.0-review.4-hotfix.10.3',
  ...
  USER_AGENT_ORDER: 'AGENT_CATALOG_ORDER',
  USER_PROJECT_ORDER: 'PROJECT_CATALOG_ORDER',
  USER_TEMPLATE_PREFIX: 'REPORT_TEMPLATE_',
  USER_DOCUMENT_ORDER_PREFIX: 'DOCUMENT_ORDER_',
